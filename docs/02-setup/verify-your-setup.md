...
- [ ] Krista requests admission — **the host must admit her**
- [ ] Krista appears in the roster with your display name and avatar
- [ ] After the meeting: transcript, summary, action items, follow-up actions

**Deliberately fail it once.** Run a second external meeting and leave Krista in
